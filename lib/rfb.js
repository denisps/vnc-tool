...
class RFBClient extends EventEmitter {
  ...
  async _handshake() {
    ...
    // After completing the handshake we immediately request a full
    // framebuffer update.  This ensures listeners begin receiving
    // "update" events without having to call captureScreen(); it also
    // kick‑starts the incremental update loop that is driven in
